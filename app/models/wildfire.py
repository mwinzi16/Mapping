...
class Wildfire(db.Model):  # type: ignore[name-defined]
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            name="ck_wildfire_confidence_range",
        ),
        CheckConstraint(
            "containment_percent >= 0 AND containment_percent <= 100",
            name="ck_wildfire_containment_range",
        ),
    )
