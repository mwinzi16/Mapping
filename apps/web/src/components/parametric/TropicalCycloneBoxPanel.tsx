...
export default function TropicalCycloneBoxPanel() {
  ...
  const handleAddBox = () => {
    ...
    const trigger: TriggerCriteria | undefined =
      newBox.minCategory || newBox.minWindKnots || newBox.maxPressureMb
        ? {
            min_category: newBox.minCategory
              ? parseInt(newBox.minCategory)
              : undefined,
            min_wind_knots: newBox.minWindKnots
              ? parseInt(newBox.minWindKnots)
              : undefined,
            max_pressure_mb: newBox.maxPressureMb
              ? parseInt(newBox.maxPressureMb)
              : undefined,
          }
        : undefined
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setNewBox({ ...newBox, minCategory: e.target.value })
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setNewBox({ ...newBox, minWindKnots: e.target.value })
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setNewBox({ ...newBox, maxPressureMb: e.target.value })
                      }
                      className="w-full px-2 py-2 bg-gray-800 border border-gray-600 rounded text-white placeholder-gray-500 text-sm"
                    />
                  </div>
  ...
  const handleSave = () => {
    const trigger: TriggerCriteria | undefined =
      editTrigger.minCategory || editTrigger.minWindKnots || editTrigger.maxPressureMb
        ? {
            min_category: editTrigger.minCategory
              ? parseInt(editTrigger.minCategory)
              : undefined,
            min_wind_knots: editTrigger.minWindKnots
              ? parseInt(editTrigger.minWindKnots)
              : undefined,
            max_pressure_mb: editTrigger.maxPressureMb
              ? parseInt(editTrigger.maxPressureMb)
              : undefined,
          }
        : undefined
          ...
          <div className="grid grid-cols-3 gap-2 pt-2">
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setEditTrigger({ ...editTrigger, minCategory: e.target.value })
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditTrigger({ ...editTrigger, minWindKnots: e.target.value })
                }
                className="w-full px-1 py-1 bg-gray-800 border border-gray-600 rounded text-white text-xs"
                placeholder="kt"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditTrigger({ ...editTrigger, maxPressureMb: e.target.value })
                }
                className="w-full px-1 py-1 bg-gray-800 border border-gray-600 rounded text-white text-xs"
                placeholder="mb"
              />
