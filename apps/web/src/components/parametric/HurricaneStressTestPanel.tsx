...
// Local stress test state (not in main store to keep it simple)
...
export default function HurricaneStressTestPanel() {
  ...
  const { boxes, selectedBoxId, filters } = useParametricStore()
