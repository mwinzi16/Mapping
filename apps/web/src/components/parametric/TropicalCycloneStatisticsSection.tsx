...
import TropicalCycloneStatisticsPanel from './TropicalCycloneStatisticsPanel'
import TropicalCycloneOverallStatsPanel from './TropicalCycloneOverallStatsPanel'
import TropicalCycloneStressTestSection from './TropicalCycloneStressTestSection'
import { useParametricStore } from '../../stores/parametricStore'

type StatisticsSubSection = 'overall' | 'by-zone' | 'stress-testing'

export default function TropicalCycloneStatisticsSection() {
      ...
      {isExpanded && (
        <div className="border-t border-gray-700/50">
          ...
          {hasBoxes && (
            <div className="px-4 py-3 border-b border-gray-700/50">
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 disabled:bg-blue-800 disabled:cursor-not-allowed text-white rounded-lg transition-colors"
              >
                {isLoadingStats ? (
                  <>
          ...
          <div className="border-b border-gray-700/50">
            ...
            {expandedSubSection === 'overall' && <TropicalCycloneOverallStatsPanel />}
          </div>
          ...
          <div className="border-b border-gray-700/50">
            ...
            {expandedSubSection === 'by-zone' && <TropicalCycloneStatisticsPanel embedded />}
          </div>
          ...
          <div>
            ...
            {expandedSubSection === 'stress-testing' && <TropicalCycloneStressTestSection />}
          </div>
        </div>
      )}
    </div>
